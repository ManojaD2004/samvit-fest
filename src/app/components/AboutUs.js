...
function AboutUs() {
  return (
    <div
     ...
     bg-[#0d0413]"
    >
      <h1 data-scroll className="text-center text-[#E23E57] font-bold hover:scale-90 transition-all ease-in-out duration-500 text-9xl">
        ABOUT FEST
      </h1>
      <div
        data-scroll
      ...
      >
        <div data-scroll>
          <p data-scroll className="text-[#de566b] text-3xl">
          ...
          <p data-scroll className="text-[#e14c62] text-3xl mt-20">
